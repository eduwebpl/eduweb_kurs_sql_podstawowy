...
INSERT INTO heroes (first_name, last_name, gender, race, strength, wisdom, health, mana, hero_id, birthdate) 
	VALUES ('Johnny', 'Monotonic', 'M', 'człowiek', 23, 33, 250, 390, 11, '1995-11-17');
INSERT INTO heroes (first_name, last_name, gender, race, strength, wisdom, health, mana, hero_id, birthdate) 
	VALUES ('Axel', 'Pulley', 'M', 'człowiek', 19, 21, 170, 230, 12, '1984-12-01');
INSERT INTO heroes (first_name, last_name, gender, race, strength, wisdom, health, mana, hero_id, birthdate) 
	VALUES ('Xena', 'Flawless', 'K', 'człowiek', 31, 10, 320, 90, 13, '1995-09-04');
...
ALTER SEQUENCE heroes_hero_id_seq RESTART WITH 14;
